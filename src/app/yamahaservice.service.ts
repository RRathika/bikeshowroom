...
export class YamahaserviceService {
  ...
  getinvoice(id:any):Observable<any>{return this.httpclient.get(this.url+`VehicleCustomerDetails/GetInvoiceNo?ShowRoomId=${id}`,{responseType:'text'});}
  ...
  getAdvanceBookingsByFilter(name:any,date:any,modelName:any):Observable<any>{return this.httpclient.get(this.url+`AdvanceBooking/GetAdvanceBookingsByFilter?Name=${name}&Date=${date}&ModelName=${modelName}`);}
}
